...
Mike is currently a Business Intelligence Architect for Pragmatic Works in Jacksonville Florida. During the past 3 years he has worked with many clients in multiple sectors to help them with High Availability, data warehousing, Integration Services, Analysis Services, Reporting Services ,SQL Server data mining, and performance tuning. Mike has spoken at several events including SQL Saturday and several Microsoft launch events
